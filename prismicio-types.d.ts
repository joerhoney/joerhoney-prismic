...
type PostDocumentDataSlicesSlice = Kustom1Slice | TextSlice | Hero2Slice;
...
/**
 * Primary content in *Kustom1 → Default → Primary*
 */
export interface Kustom1SliceDefaultPrimary {
  /**
   * Kustom Image field in *Kustom1 → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: kustom1.default.primary.kustom_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  kustom_image: prismic.ImageField<never>;

  /**
   * Kustom Caption field in *Kustom1 → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: kustom1.default.primary.kustom_caption
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  kustom_caption: prismic.RichTextField;
}

/**
 * Default variation for Kustom1 Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type Kustom1SliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<Kustom1SliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *Kustom1*
 */
type Kustom1SliceVariation = Kustom1SliceDefault;

/**
 * Kustom1 Shared Slice
 *
 * - **API ID**: `kustom1`
 * - **Description**: Kustom1
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type Kustom1Slice = prismic.SharedSlice<
  "kustom1",
  Kustom1SliceVariation
>;
